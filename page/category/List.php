        ...
        <div class="page-content">
            ...
            <div class="pt-5">
                <div class="panel h-full flex-col">
                    ...
                    <form id="formCategory" class="space-y-5 dark:text-white">
                        <div>
                            <?= input("text", "category", null, "Category Name", "w-1/4 mt-2", false) ?>
                        </div>
                        <div>
                            <?= button("submit", "btnCreate", "+ Create Category",  "mb-2 px-2 py-2", false) ?>
                        </div>
                    </form>
