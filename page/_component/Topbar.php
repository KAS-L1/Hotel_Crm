                                ...
                                <div class="flex space-x-2">
                                    ...
                                    <?php if (!empty($notifications)): ?>
                                        <form method="POST" class="inline">
                                            ...
                                            <button type="submit" class="text-xs text-danger hover:text-danger-dark" onclick="return confirm('Delete all notifications?')">
                                                Clear all
                                            </button>
                                        </form>
                                    <?php endif; ?>
                                            ...
                                            <div class="flex flex-auto items-center justify-between ltr:pl-3 rtl:pr-3">
                                                ...
                                                <div class="flex space-x-2">
                                                    ...
                                                    <form method="POST" class="inline">
                                                        ...
                                                        <input type="hidden" name="notification_id" value="<?= $notification['id'] ?>">
                                                        <button type="submit" class="text-danger hover:text-danger-dark" title="Delete" onclick="return confirm('Delete this notification?')">
                                                            <svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <ul class="horizontal-menu hidden border-t border-[#ebedf2] bg-white px-6 py-1.5 font-semibold text-black rtl:space-x-reverse dark:border-[#191e3a] dark:bg-[#0e1726] dark:text-white-dark lg:space-x-1.5 xl:space-x-8">
            ...
            <li class="menu nav-item relative">
                <a href="javascript:;" class="nav-link">
                    <div class="flex items-center">
                        <i class="fa-solid fa-shopping-cart shrink-0 group-hover:text-primary text-current opacity-50"></i>
            ...
            <li class="menu nav-item relative">
                <a href="javascript:;" class="nav-link">
                    <div class="flex items-center">
                        <i class="fa fa-clipboard-list shrink-0 group-hover:text-primary text-current opacity-50"></i>
                        <span class="px-1">Audit Management</span>
                    </div>
                    <div class="right_arrow">
                        <svg class="h-4 w-4 rotate-90" width="16" height="16" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
            ...
            <li class="nav-item relative">
                <a href="apps-calendar.html" class="nav-link group">
                    <div class="flex items-center">
                        <i class="fa fa-file-contract shrink-0 group-hover:text-primary text-current opacity-50"></i>
                        <span class="px-1">Document Tracking</span>
                    </div>
                </a>
            </li>
            ...
            <li class="menu nav-item relative">
                <a href="javascript:;" class="nav-link">
                    <div class="flex items-center">
                        <i class="fa fa-building shrink-0 group-hover:text-primary text-current opacity-50"></i>
                        <span class="px-1">Vendor Portal</span>
                    </div>
                    <div class="right_arrow">
                        <svg class="h-4 w-4 rotate-90" width="16" height="16" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
