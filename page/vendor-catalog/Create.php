            ...
            <div class="mb-5 grid grid-cols-1 gap-5 lg:grid-cols-3 xl:grid-cols-4">
                <div class="panel">
                    <div class="mb-5 flex items-center justify-between">
                        <h5 class="text-lg font-semibold dark:text-white-light">Product Image</h5>
                    </div>
                    <div class="mb-5">
                                ...
                                <div class="grid flex-1 grid-cols-1 gap-5 sm:grid-cols-2 ml-2">
                                    <div>
                                        ...
                                        <div class="relative text-white-dark mb-4">
                                            <?= input("text", "name", null, null, null, null, 'required') ?>
                                        </div>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative text-white-dark mb-4">
                                            <?= input("number", "unit_price", null, null, null, null, 'required') ?>
                                        </div>
                                    </div>
                                    <div>
                                        <label for="stock">Stock</label>
                                        <div class="relative text-white-dark mb-4">
                                            <?= input("number", "stock", null, null, null, null, 'required') ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="sm:col-span-2">
                                        <?= button("submit", "btnSubmit", "Create Product", null) ?>
                                    </div>
                                </div>
                            </div>
                        </form>
